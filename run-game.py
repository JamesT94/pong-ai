...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, controls, y_pos):
    ...
    def update(self):
        ...
        # Move x according to the input. We multiply by 15 to speed up the movement.
        self.rect.x = int(self.rect.x + x_axis_pos * 15)
...
player1 = Player('Arrows', 580)
player2 = Player('WASD', 25)
...
while not exit_program:
    ...
    # Print the score
    score_print = "Player 1: " + str(score1)
    text = font.render(score_print, True, WHITE)
    text_pos = (0, 0)
    screen.blit(text, text_pos)

    score_print = "Player 2: " + str(score2)
    text = font.render(score_print, True, WHITE)
    text_pos = (300, 0)
    screen.blit(text, text_pos)
